                ...
                <div class="col-lg-3 col-md-6">
                    <div class="widget-item">
                        ...
                        <div class="widget-body">
                            <p>Изделий ручной работы из эпоксидной смолы. Наполнители как из натуральных, так и из искусственных материалов.</p>
                        </div>
                    </div>
                </div>
                {{--                <div class="col-lg-3 col-md-6">--}}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="copyright-text text-center">
                        <p>2021 Изделия ручной работы из эпоксидной смолы <a href="#">jepoxy</a></p>
                    </div>
                </div>
            </div>
        </div>
